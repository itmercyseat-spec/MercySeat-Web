        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-3">
                {[
                  { label: "Boksburg", addr: "678 Elephant St, Villa Liza, Boksburg, 1459" },
                  { label: "Tshepisong", addr: "4780 Cnr Abraham Tiro & Dulcie September Street, Phase 7, Tshepisong" },
                  { label: "Mpumalanga", addr: "Schoesmandal Station, KaSombo, Mpumalanga" },
                ].map((loc) => (
                  <a
                    key={loc.label}
