    ...
    <footer className="bg-primary text-primary-foreground mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-3">
                {[
                  {
                    label: "Boksburg",
                    addr: "678 Elephant St, Villa Liza, Boksburg, 1459",
                  },
                  {
                    label: "Tshepisong",
                    addr: "4780 Cnr Abraham Tiro & Dulcie September Street, Phase 7, Tshepisong",
                  },
                  {
                    label: "Mpumalanga",
                    addr: "Schoesmandal Station, KaSombo, Mpumalanga",
                  },
                ].map((loc) => (
                  <a
                    key={loc.label}
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              <a
                href="https://www.facebook.com/MercySeatFamilyFellowship/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-accent hover:text-accent-foreground flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://www.youtube.com/@MercySeat-ff"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-accent hover:text-accent-foreground flex items-center justify-center transition-colors"
                aria-label="YouTube"
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center text-sm text-primary-foreground/60">
          <p>
            &copy; {new Date().getFullYear()} Mercy Seat Family Fellowship. All
            rights reserved.
          </p>
        </div>
      </div>
